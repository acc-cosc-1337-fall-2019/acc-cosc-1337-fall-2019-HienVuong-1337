...
and displays the numbers to screen using an indexed for loop as follows: 9 10 99 5  67
*/
//pass by value is a copy of parameter and original value is not changed
...
and displays the numbers to screen using an indexed for loop as follows : 9 10 99 5  67
*/
//pass by reference points to original location and can change the original vector

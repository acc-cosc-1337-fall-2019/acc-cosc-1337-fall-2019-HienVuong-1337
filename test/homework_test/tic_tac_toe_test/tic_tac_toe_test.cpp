...
TEST_CASE("Test win by diagonally from top left", "[X wins diagonally from top left]")
{
	TicTacToe board;
	board.start_game("X");
	REQUIRE(board.game_over() == false);
...
TEST_CASE("Test win by diagonally from bottom left", "[X wins diagonally from bottom left]")
{
	TicTacToe board;
	board.start_game("X");
	REQUIRE(board.game_over() == false);
